  ...
  <main class="bg-zinc-900 relative">
    <div class="text-white flex relative justify-center items-center h-screen overflow-hidden max-w-[1000px] mx-auto">
      <blockquote>
        ...
        <!-- eslint-disable-next-line vue/singleline-html-element-content-newline -->
        <h3 v-if="data" class="mt-6 text-xl text-zinc-300 font-montserrat">- {{ data.author }}</h3>
      </blockquote>
    </div>

    <div class="absolute bottom-4 text-left left-4 flex gap-2">
      <div class="text-zinc-500 hover:text-zinc-300 transition hover:transition cursor-pointer" @click="handleOpenSetting()">
